from llmfoundry.models.hf.hf_as_mpt.modeling_llama import Llama7bAsMPT
import torch
import transformers
from transformers import PreTrainedModel
from transformers.models.llama.configuration_llama import LlamaConfig

from tests.a_scripts.inference.test_convert_composer_to_hf import check_hf_model_equivalence
...
def test_llama_from_save_pretrained():
    ...
    original_llama = transformers.AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-hf", num_hidden_layers=2)

    # Patch the llama implementation
    from transformers.models.auto.modeling_auto import MODEL_FOR_CAUSAL_LM_MAPPING
    MODEL_FOR_CAUSAL_LM_MAPPING._extra_content[LlamaConfig] = Llama7bAsMPT

    # Load the patched llama
    patched_llama = transformers.AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-hf", num_hidden_layers=2)
    ...
    reloaded_original_llama = transformers.AutoModelForCausalLM.from_pretrained("original_llama", num_hidden_layers=2)
    reloaded_patched_llama = transformers.AutoModelForCausalLM.from_pretrained("patched_llama", num_hidden_layers=2)
